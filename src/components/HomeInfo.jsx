...
const renderCountent = {
  1: (
    <h1 className="font-light sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5">
      ...
      <br />A Front-end Engineer from Los Angeles!
    </h1>
  ),
  2: (
    <InfoBox
  ...
  3: (
    <InfoBox
      text="I bring a myriad of experience from multiple industries and a fresh perspective to front-end development."
  ...
  4: (
    <InfoBox
      ...
      link="/education"
      btnText="View about my education"
    />
  ),
};
